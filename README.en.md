...
- doctor, `pipeline --json-out` structured eval runs, loop state JSON, configurable failure categories, escalation learn drafts, Markdown summaries/history reports, AC/drift/compliance gate JSON, review/TDD process evidence, and GitHub Actions eval artifacts/Step Summary/best-effort PR comments;
...
- failure category config lint and learn draft promotion workflow;
