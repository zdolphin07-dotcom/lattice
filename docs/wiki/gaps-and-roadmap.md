...
| Evidence 已有 pipeline/gate JSON、loop state、escalation learn draft、process evidence、Markdown summary、history report、CI artifact 与 PR comment 模板，但 promotion 仍弱 | 候选经验可能停留在 drafts | learn draft promotion workflow |
...
2. 增加 failure category schema 与 learn draft promotion workflow。
