...
| Orchestrator | Agent 规则、阶段定义、模板入口、spec 状态推进、plan contract lint 和任务证据校验 | `lattice/kernel/orchestrator/`、`spec-state-lint.sh`、`spec-status.sh`、`plan-lint.sh`、`task-evidence-lint.sh` |
