...
- README and wiki now describe pipeline/gate eval JSON, review/TDD process evidence, Markdown summaries, GitHub Actions artifacts, Step Summary, and PR comments as implemented.
